    ...
    return (
        <nav className='flex items-center justify-between flex-wrap bg-black p-6'>
            <div className='flex items-center flex-shrink-0 text-white mr-6'>
                <Link to='/' className='font-semibold text-xl tracking-tight'>McQueen Industries</Link>
            </div>
            <div className='block'>
            ...
            { isVisible ? (
                <div className='w-full block flex-grow items-center'>
                    <div className="text-sm lg:flex-grow">
                        ...
                        <Button className='p-3 m-5 bg-red-600 justify-center'>
                            <div>
                                <a href='https://www.autotrader.com/' target='_blank' rel='noopener noreferrer' className='flex place-items-center mt-4 lg:inline-block lg:mt-0 text-black hover:text-white mr-4'>
                                    Buy More Cars
                                </a>
                            </div>
                        </Button>
